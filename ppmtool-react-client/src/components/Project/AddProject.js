                    ...
                    <form onSubmit={this.onSubmit}>
                        <div className="form-group">
                            ...
                            onChange={this.onChange}
                             />
                             {errors.projectName && (
                                 <div className = "invalid_feedback">{errors.projectName}</div>
                             )}
                        </div>
                        <div className="form-group">
                            <input type="text" 
                            className={classnames("form-control form-control-lg ",{
                                "is_invalid":errors.projectIdentifier
                            })}
                             ...
                             {errors.projectIdentifier && (
                                <div className = "invalid_feedback">{errors.projectIdentifier}</div>
                            )}
                        </div>
                        <div className="form-group">
                            <textarea 
                            className={classnames("form-control form-control-lg ",{
                                "is_invalid":errors.description
                            })}
                            placeholder="Project Description"
                            name="description" value = {this.state.description}
                            onChange={this.onChange}></textarea>
                            {errors.description && (
                                <div className = "invalid_feedback">{errors.description}</div>
                            )}
